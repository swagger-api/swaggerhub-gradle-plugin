...
A simple maven plugin to access [SwaggerHub](https:\\swaggerhub.com) hosting of [OpenAPI/Swagger](https://swagger.io/specification/) from a gradle build process, primarily to integrate with other OpenAPI/Swagger mavgradleen tooling.
